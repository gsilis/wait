...
export default function ColorSurveyChangeMind(sf: SequenceFactory): Sequence[] {
  return [
    ...
    sf.create(YesYouDidStoryId, (df, _se, cf) => {
      return [
        df.message('Reality Check', 'Yes you did!'),
        df.custom('Time Out', cf.componentWithChildren(WaitToClick, <DialogPrimaryText>Well, if you're going to be like that, we're going to take a little break.</DialogPrimaryText>, { timeOut: 20000 }), () => {}),
